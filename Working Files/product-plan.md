# Product plan · Australian Payroll Association

## What we're actually building and why

In one sentence: a CRM that puts every new membership, training, and
consulting lead in one view the moment it arrives — so a lead can never
sit unseen and untouched again, which is the exact gap you named: nobody
today has a single view of where the new leads are.

Who it's for: you as the operator (and your sales team working the
pipeline), plus the person who fills out the form on payrollgroup.com.au —
someone weighing membership, training, or a consulting engagement with the
...
My business: Australian Payroll Association — membership, training, and consulting
My inquiry types (contacts.type enum): membership, training, consulting, general_enquiry, newsletter_signup
My design system: Minimalist Apple
My brand colors: #485e88 (slate blue, primary), #ecbd3d (gold, accent), #a0aec1 (muted blue-grey, neutral)
My custom attributes (people.attributes jsonb keys):
  - membership_type — pick-from-a-list — Professional Member / Beryl Member / Non-Member
  - organisation_size — pick-from-a-list — 1–50 / 51–200 / 201–500 / 501–1,000 / 1,000+
  - membership_renewal_date — date — the date their current membership is due to renew
My domain: payrollgroup.com.au
...
- At my real inquiry volume from Q2 (~40 inquiries a week), this keeps up
